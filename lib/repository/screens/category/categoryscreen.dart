...
class CategoryScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> secondgrocery = [
    ...
    {"img": "image 24.png", "text": "Ice Cream & \nmuch more"},
    {"img": "image 25.png", "text": "Noodle & \nPocket Food"},
  ];
  ...
  final List<Map<String, String>> household = [
    {"img": "image 36.png", "text": "Surf excel"},
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionTitle("Some other Grocery"),
  ...
  // 🟢 Widget for Horizontal ListView
  Widget _buildHorizontalList(List<Map<String, String>> items,
      {bool isTextVisible = true}) {
    return SizedBox(
      height: 120, // FIX: Set height for ListView
